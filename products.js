/* ============================================================
   ...
   New products use a placeholder image (Products/Vials/placeholder.png);
...
const PRODUCTS = [
  ...
  { id:'bpc157', name:'BPC-157', benefit:'recovery', cat:'Pentadecapeptide', ph:'#b69487',
    img:'Products/Vials/clean/vial_bpc147.png', detailVideo:'bpc157_float_card.mp4', blurb:'Gastric pentadecapeptide',
    dose:'10 mg · 5 mL', price:95, variants:[{dose:'10 mg', vial:'5 mL', price:95}],
  ...
  { id:'tb500', name:'TB-500', benefit:'recovery', cat:'Thymosin β4 fragment', ph:'#c0a79c',
    img:PH, blurb:'Synthetic thymosin beta-4 fragment',
    dose:'10 mg · 5 mL', price:110, variants:[{dose:'10 mg', vial:'5 mL', price:110}],
    tagline:'The thymosin fragment behind actin and tissue-repair research.',
  ...
  { id:'wolverine', name:'Wolverine', benefit:'recovery', cat:'Repair peptide blend', composition:'BPC-157 / TB-500', blend:[{name:'BPC-157',dose:'10 mg'},{name:'TB-500',dose:'10 mg'}], ph:'#b89a8e',
    img:PH, blurb:'BPC-157 and TB-500 repair blend',
    dose:'10 / 10 mg · 5 mL', price:150, variants:[{dose:'10 / 10 mg', vial:'5 mL', price:150}],
    tagline:'Two repair peptides studied in one research blend.',
  ...
  { id:'ghk-cu', name:'GHK-Cu', benefit:'skin', cat:'Copper tripeptide', ph:'#cdbb95',
    img:PH, blurb:'Copper tripeptide GHK-Cu',
    dose:'50 mg · 10 mL', price:110, variants:[{dose:'50 mg', vial:'10 mL', price:110}],
    tagline:'The copper tripeptide behind skin-matrix research.',
  ...
  { id:'glow', name:'GLOW', benefit:'skin', cat:'Skin-matrix blend', composition:'GHK-Cu / BPC-157 / TB-500', blend:[{name:'GHK-Cu',dose:'50 mg'},{name:'BPC-157',dose:'10 mg'},{name:'TB-500',dose:'10 mg'}], ph:'#cdbb95',
    img:'Products/Vials/clean/vial_glow.png', detailVideo:'glow_float_card.mp4', blurb:'GHK-Cu, BPC-157 and TB-500 blend',
    dose:'50 / 10 / 10 mg · 10 mL', price:180, variants:[{dose:'50 / 10 / 10 mg', vial:'10 mL', price:180}],
    tagline:'A three-peptide blend studied for skin-matrix and repair.',
  ...
  { id:'klow', name:'KLOW', benefit:'skin', cat:'Skin-matrix blend', composition:'GHK-Cu / BPC-157 / TB-500 / KPV', blend:[{name:'GHK-Cu',dose:'50 mg'},{name:'BPC-157',dose:'10 mg'},{name:'TB-500',dose:'10 mg'},{name:'KPV',dose:'10 mg'}], ph:'#c8b48f',
    img:PH, blurb:'GHK-Cu, BPC-157, TB-500 and KPV blend',
    dose:'50 / 10 / 10 / 10 mg · 10 mL', price:200, variants:[{dose:'50 / 10 / 10 / 10 mg', vial:'10 mL', price:200}],
    tagline:'A four-peptide blend spanning skin-matrix, repair and KPV.',
  ...
  { id:'glutathione', name:'Glutathione', benefit:'skin', cat:'Tripeptide antioxidant', ph:'#b39184',
    img:'Products/Vials/clean/vial_glutathione.png', detailVideo:'glutathione_float_card.mp4', blurb:'Reduced glutathione (GSH)',
    dose:'1500 mg · 10 mL', price:95, variants:[{dose:'1500 mg', vial:'10 mL', price:95}],
    tagline:'The cell’s primary antioxidant, prepared for research.',
  ...
  { id:'semax', name:'Semax', benefit:'vitality', cat:'ACTH(4-10) analog', ph:'#bcbd98',
    img:PH, blurb:'ACTH(4-10)-related heptapeptide',
    dose:'10 mg · 5 mL', price:85, variants:[{dose:'10 mg', vial:'5 mL', price:85}],
    tagline:'The ACTH-related heptapeptide in neuropeptide research.',
  ...
  { id:'selank', name:'Selank', benefit:'vitality', cat:'Tuftsin analog', ph:'#b9b893',
    img:'Products/Vials/clean/vial_selank.png', detailVideo:'selank_float_card.mp4', blurb:'Synthetic tuftsin analog',
    dose:'10 mg · 5 mL', price:80, variants:[{dose:'10 mg', vial:'5 mL', price:80}],
    tagline:'A tuftsin analog studied in stress-response signalling.',
  ...
  { id:'pt141', name:'PT-141', benefit:'vitality', cat:'Melanocortin agonist', ph:'#b3b48c',
    img:PH, blurb:'Melanocortin receptor agonist',
    dose:'10 mg · 5 mL', price:90, variants:[{dose:'10 mg', vial:'5 mL', price:90}],
    tagline:'The melanocortin agonist studied in receptor signalling.',
  ...
  { id:'nad', name:'NAD+', benefit:'vitality', cat:'Cellular coenzyme', ph:'#b6b48f',
    img:'Products/Vials/clean/vial_nad+.png', detailVideo:'nad_float_card.mp4', blurb:'Nicotinamide adenine dinucleotide',
    dose:'1000 mg · 10 mL', price:120, variants:[{dose:'1000 mg', vial:'10 mL', price:120}],
    tagline:'The coenzyme at the centre of cellular-energy research.',
  ...
  { id:'glp1s', name:'GLP-1 S', benefit:'metabolic', cat:'GLP-1 analog', ph:'#9aa6b0',
    img:PH, blurb:'GLP-1 receptor agonist analog',
    dose:'10 mg · 5 mL', price:150,
    variants:[{dose:'10 mg', vial:'5 mL', price:150},{dose:'30 mg', vial:'10 mL', price:320}],
    tagline:'The incretin analog at the centre of metabolic research.',
  ...
  { id:'glp2t', name:'GLP-2 T', benefit:'metabolic', cat:'GLP-2 analog', ph:'#94a1ad',
    img:PH, blurb:'GLP-2 analog peptide',
    dose:'10 mg · 5 mL', price:150,
    variants:[{dose:'10 mg', vial:'5 mL', price:150},{dose:'30 mg', vial:'10 mL', price:320}],
    tagline:'The intestinal incretin studied for gut-tissue signalling.',
  ...
  { id:'glp3r', name:'GLP-3 R', benefit:'metabolic', cat:'GLP-family peptide', ph:'#9aa6b0',
    img:'Products/Vials/clean/vial_bpcglp-3.png', detailVideo:'glp3_float_card.mp4', blurb:'Next-generation GLP-family metabolic peptide',
    dose:'10 mg · 5 mL', price:160,
    variants:[{dose:'10 mg', vial:'5 mL', price:160},{dose:'30 mg', vial:'10 mL', price:340}],
    tagline:'A next-generation peptide in the GLP metabolic family.',
  ...
  { id:'cagrilintide', name:'Cagrilintide', benefit:'metabolic', cat:'Amylin analog', ph:'#94a1ad',
    img:PH, blurb:'Long-acting amylin analog',
    dose:'10 mg · 5 mL', price:170, variants:[{dose:'10 mg', vial:'5 mL', price:170}],
    tagline:'The long-acting amylin analog in appetite-signalling research.',
  ...
  { id:'motsc', name:'MOTS-C', benefit:'metabolic', cat:'Mitochondrial peptide', ph:'#9aa6b0',
    img:PH, blurb:'Mitochondrial-derived signalling peptide',
    dose:'10 mg · 5 mL', price:120, variants:[{dose:'10 mg', vial:'5 mL', price:120}],
    tagline:'The mitochondrial-derived peptide in metabolic research.',
  ...
  { id:'glp1s-bpc', name:'GLP-1 S / BPC-157', benefit:'metabolic', cat:'GLP-1 + BPC-157', composition:'GLP-1 S / BPC-157', blend:[{name:'GLP-1 S',dose:'5 mg'},{name:'BPC-157',dose:'650 mcg'}], ph:'#9aa6b0',
    img:PH, blurb:'GLP-1 analog and BPC-157 blend',
    dose:'5 mg / 650 mcg · 5 mL', price:140, variants:[{dose:'5 mg / 650 mcg', vial:'5 mL', price:140}],
    tagline:'An incretin analog and a repair peptide, studied together.',
  ...
  { id:'glp2t-bpc', name:'GLP-2 T / BPC-157', benefit:'metabolic', cat:'GLP-2 + BPC-157', composition:'GLP-2 T / BPC-157', blend:[{name:'GLP-2 T',dose:'30 mg'},{name:'BPC-157',dose:'1.3 mg'}], ph:'#94a1ad',
    img:PH, blurb:'GLP-2 analog and BPC-157 blend',
    dose:'30 mg / 1.3 mg · 10 mL', price:200, variants:[{dose:'30 mg / 1.3 mg', vial:'10 mL', price:200}],
    tagline:'An intestinal incretin and a repair peptide, studied together.',
  ...
  { id:'cjc-ipa', name:'CJC-1295 / Ipamorelin', benefit:'somatotropic', cat:'GHRH + secretagogue', composition:'CJC-1295 / Ipamorelin', blend:[{name:'CJC-1295',dose:'5 mg'},{name:'Ipamorelin',dose:'5 mg'}], ph:'#9db3b5',
    img:PH, blurb:'GHRH analog and GH secretagogue blend',
    dose:'5 / 5 mg · 5 mL', price:130, variants:[{dose:'5 / 5 mg', vial:'5 mL', price:130}],
    tagline:'A paired study of the somatotropic axis.',
  ...
  { id:'tesamorelin', name:'Tesamorelin', benefit:'somatotropic', cat:'GHRH analog', ph:'#9db3b5',
    img:PH, blurb:'GHRH analog peptide',
    dose:'10 mg · 5 mL', price:150, variants:[{dose:'10 mg', vial:'5 mL', price:150}],
    tagline:'The GHRH analog studied in the somatotropic axis.',
  ...
  { id:'research-water', name:'Research Water', benefit:'supplies', cat:'Bacteriostatic water', ph:'#b4bcc0',
    ...
    dose:'30 mL', price:25,
    variants:[{dose:'30 mL', vial:'', price:25},{dose:'10 mL', vial:'', price:15}],
    tagline:'The reconstitution supply for dissolving lyophilised research peptides.',
